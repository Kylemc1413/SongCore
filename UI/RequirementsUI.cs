    ...
    public class RequirementsUI : NotifiableSingleton<RequirementsUI>
    {
        ...
        internal void ShowRequirements()
        {
            ...
            if (diffData != null)
            {
                ...
                {
                    customListTableData.data.Add(new CustomCellInfo($"<size=75%>Custom Colors Availaible", $"Click here to preview & {(Plugin.Configuration.CustomSongColors ? "disable" : "enable")} it.", ColorsIcon));
                }
